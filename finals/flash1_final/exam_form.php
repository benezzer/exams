  ...
  <div class="content">
    ...
    <table border="0" cellspacing="2" cellpadding="10" width="960">
        ...
        <tr>
          ...
          <td width="475" valign="top"><p>In the command <strong>this.stop();</strong></p>
          	<p>the Parentheses after the word <strong>stop</strong> indicates the it is a function.</p></td>
        </tr>
        <tr>
          ...
          <td width="475" valign="top"><p>Actions can only be added to a normal frame</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="475" valign="top"><p>Actions can only be written in all capital letters</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="475" valign="top"><p>an Instance is the appearance of a symbol on the stage</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="475" valign="top"><p>In order to apply filters such as   drop shadow the object must be an instance of a symbol, or a text object</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="475" valign="top"><p>In order to test in a browser, the   shortcut on Mac is command+return (enter)</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="475" valign="top"><p>masks (the mask layer itself) in Animate use only vector fills, and ignores the strokes</p></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="475" valign="top"><p>Shape tween can be done only between bitmaps</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="475" valign="top"><p>the shortcut for &quot;break apart&quot; (on Mac) is command+B</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="475" valign="top"><p>The brush tool draws only fills, not   strokes &nbsp; </p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="475" valign="top"><p>Every bitmap in the library can be   compressed to a diffrent jpg quality.</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="475" valign="top"><p>Text (editable text) cannot be filled with a gradient,   only with solid colors </p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="475" valign="top"><p>The stage color must be a web-safe color </p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="475" valign="top"><p>The pencil tool draws only strokes, not   fills </p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="475" valign="top"><p>Only one instance on one layer at a time   can be motion tweened </p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="475" valign="top"><p>The shortcut for inserting a normal frame   is F9 </p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="475" valign="top"><p>The difference between a rectangle and a   primitive rectangle is that a primitive can have no strokes (borders) </p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="475" valign="top"><p>A blank keyframe is a keyframe with no   content. </p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="475" valign="top"><p>If you import a jpg to the stage in   Animate, then scale it with the free transform tool to be smaller, you will <strong>not</strong> save kilobytes </p></td>
        </tr>
        <tr>
