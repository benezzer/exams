  ...
  <div class="content">
    ...
    <table border="0" cellspacing="2" cellpadding="10" width="960">
        ...
        <tr>
          ...
          <td width="475" valign="top"><p>When importing bitmaps into Flash, the prefered format is .jpg</p></td>
        </tr>
        <tr>
          ...
          <td width="475" valign="top"><p>In order to load a swf into a   movie clip, we need to declare a <strong>SWFParent </strong>object</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="475" valign="top"><p>In order to load a swf into a   movie clip, we need to declare a <strong>ChildSWF</strong> object</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="475" valign="top"><p>Instance names can contain   numbers, as long as they don&rsquo;t start with a number </p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="475" valign="top"><p>In order to apply filters such as   drop shadow or blur, the object needs to be a button, a movie clip, or text.</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="475" valign="top"><p>In order to test a swf, the   shortcut on Mac is command+Enter(return)  </p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="475" valign="top"><p>In order for buttons to have   actionscript functions, they need an instance name</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="475" valign="top"><p>Only a bitmap can be used as a   mask.</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="475" valign="top"><p>Instance names can not contain   capital letters</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="475" valign="top"><p>the display_mc movie clip needs to have its registration point at the top left in order for external swf's to load correctly.</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="475" valign="top"><p>Attaching a function to a button   starts with the instance name of the button, then <strong>.addEventListener</strong>() with its 2 parameters, the event and the name of the function</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="475" valign="top"><p>Every bitmap in the library can be   compressed differently.</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="475" valign="top"><p>The two parameters of<strong> addEventListener()</strong> are the event, and a function name</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="475" valign="top"><p>Every state of a button symbol   (up, over, down), must contain a movie clip for the button to function</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="475" valign="top"><p>In order to load a swf into   another swf, we need to declare a <strong>Loader</strong> object</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="475" valign="top"><p>The function <strong>addChildAt()</strong> has 2   parameters, the loader, and the index level</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="475" valign="top"><p>When loading one flash file into   another, the one being loaded can only be an FLA, not an SWF</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="475" valign="top"><p>Flash banner animations in actionscript FLA format can be converted to HTML5 canvas FLA format. But not the other way round.</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="475" valign="top"><p>In order to load a swf, first we   need to declare a <strong>URLRequest</strong></p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="475" valign="top"><p>you can not put a button inside another button.</p></td>
        </tr>
        <tr>
