  ...
  if(isset($_POST['firstName'])){ ?>
    <table width="661" border="0" cellspacing="0" cellpadding="7">
      <tr>
        ...
        <td width="577"><h2 class="myemph">Results: Feel free to print for your records</h2>
      ...
      <tr>
        <td align="right">&nbsp;</td>
        <td><h2>Student ID: <?php echo $_POST['sudentId'];?></h2>
          <h2>&nbsp;</h2></td>
      </tr>
      <tr>
        <td align="right">&nbsp;</td>
