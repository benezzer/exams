  ...
  <div class="content">
    ...
    <table border="0" cellspacing="2" cellpadding="10" width="960">
        ...
        <tr>
          ...
          <td width="389" valign="top"><p>The human frequency   range is from 20Hz to 20,000Hz</p></td>
        </tr>
        <tr>
          ...
          <td width="389" valign="top"><p>The HTML &lt;video&gt; tag can use only WEBM files.</p></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="389" valign="top"><p>Both the &lt;audio&gt; and the &lt;video&gt; tag can contain an optional attribute called autoplay</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="389" valign="top"><p>The HTML &lt;audio&gt; tag can use MP3 and OGG files.</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="389" valign="top"><p>The recommended data rate of mp4 videos at 480 resolution is about 2500 Kbps.</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="389" valign="top"><p>The attribute <strong>controls</strong> for both audio and video looks different in each browser</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="389" valign="top"><p> In order vor a video playing inside an iframe to be able to go full screen, the iframe needs to have the attribute <strong>allowfullscreen</strong></p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="389" valign="top"><p>If an &lt;audio&gt; tag doesn't have the <strong>controls</strong> attribute, then it is invisible in the browser</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="389" valign="top"><p>The Adobe Media Encoder can convert video files to WEBM format</p></td>
        </tr>
        <tr>
          ...
          <td width="201" valign="top" bgcolor="#E0D9C4"><div id="spryradio11">
          	...
          	<span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="389" valign="top"><p>the &lt;iframe&gt; tag needs a width and a height attribute, in the HTML</p></td>
          </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="389" valign="top"><p>VBR 2 pass encoding is better than CBR, but will take more time to encode</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="389" valign="top"><p>to clean a sound from noise in Audition, first we have to <strong>capture a noise print</strong></p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="389" valign="top"><p>The &lt;video&gt; tag works only in HTML5</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="389" valign="top"><p>in <strong>dB digital</strong>, OdB is the absolute   maximum volume</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="389" valign="top"><p>javaScript can rewrite CSS, but only in the HTML (not external CSS)</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="389" valign="top"><p>In Audition, noise reduction is meant to work only on steady, constant, mechanical noise such as hiss</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="389" valign="top"><p> in the &lt;video&gt; tag the poster img can be a jpg, a gif or a png</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="389" valign="top"><p>Normalizing an audio   file means cleaning it from background noise</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="389" valign="top"><p>The resolution of video is always measured by its width.</p></td>
        </tr>
        <tr>
