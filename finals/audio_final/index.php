...
<div class="container">
  ...
  <div id="ip"></div>
    ...
    <ol>
      ...
      <li><strong>Important: if I get 2 email different email results from the same student/IP address, this means the student tried to take the test a second time, and will be considered cheating.</strong></li>
    </ol>
