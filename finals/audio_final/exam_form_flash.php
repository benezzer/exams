...
<div class="container">
  <div class="header"><!-- end .header -->
    <h1>Audio for Interactive Design  - Final exam</h1>
  </div>
  <div class="content">
    ...
    <table border="0" cellspacing="2" cellpadding="10" width="960">
        ...
        <tr>
          ...
          <td width="389" valign="top"><p>In actionscript, XML attributes are called <strong>element, </strong>and are identified with the   symbol<strong> @</strong></p></td>
        </tr>
        <tr>
          ...
          <td width="389" valign="top"><p>Flash can load external sounds only if they are   WAV&rsquo;s</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="389" valign="top"><p>The human dynamic (volume) range is from 20Hz to   20KHz</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="389" valign="top"><p>if we write<br>
            <strong>addEventListener(Event.ENTER_FRAME,   myFunc);</strong><br>
            then the function myFunc will be called (executed)   only once, at the very beginning of the swf.</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="389" valign="top"><p>The property <strong>playheadTime</strong> is a property of the video player, and is measured in Seconds.</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="389" valign="top"><p>The <strong>position</strong> property &ldquo;belongs&rdquo; to the <strong>SoundChannel</strong> object</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="389" valign="top"><p>to load an flv/f4v into an flvPlayer component   instance, we first need to declare a <strong>Loader</strong> object</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="389" valign="top"><p>The <strong>SoundLoaderContext</strong> object is used in   order to define the buffer.</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="389" valign="top"><p>The compression for the  <strong>flv</strong> format is better and more efficient than the one in the  <strong>f4v</strong> format</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="389" valign="top"><p>When controlling sound in AS3, The <strong>stop() </strong>function   &ldquo;belongs&rdquo; to the <strong>Sound </strong>object</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="389" valign="top"><p>The <strong>play()</strong> method (of a Sound) has an   optional parameter, the start offset, in mS.</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="389" valign="top"><p>The <strong>stop()</strong> command has no parameters.</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="389" valign="top"><p>There is no <strong>pause()</strong> for video in   ActionScript 3.</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="389" valign="top"><p>to change the flv/f4v   playing currently in an flv Player,    all we need is to change the flvPlayer&rsquo;s<strong> source;</strong></p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="389" valign="top"><p>In order to drag an object, within constraints,   first we have to declare a  <strong>new</strong> <strong>Rectangle</strong></p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="389" valign="top"><p>The <strong>volume </strong>property   in AS3 has a value range between 0 and 100</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="389" valign="top"><p>In a <strong> new   Rectangle(0,0,100,0); </strong>the first number is the width</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="389" valign="top"><p>In order to play flv&rsquo;s the user will need flash   player 11 or higher.</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="389" valign="top"><p>In order for AS3 to place an instance of a symbol   on the stage, we need to check &ldquo;export for actionScript&rdquo; in the symbol   properties, and give it a Class name</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="389" valign="top"><p>In order to change the <strong>volume (of a soundChannel)</strong>, we first need to declare a <strong>SoundTransform</strong> object</p></td>
        </tr>
        <tr>
