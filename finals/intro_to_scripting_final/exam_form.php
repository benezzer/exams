...
<head>
<meta charset="UTF-8">
<title>Intro to Scripting- Midterm exam</title>
...
<div class="container">
  <div class="header"><!-- end .header -->
    <h1>Intro to Scripting- Final exam</h1>
  </div>
  <div class="content">
    ...
    <table border="0" cellspacing="2" cellpadding="10" width="960">
        ...
        <tr>
        	...
        	<td valign="top" bgcolor="#E3E3E3"><p>JavaScript is a client side language.</p></td>
        	</tr>
        <tr>
        	...
        	<td valign="top" bgcolor="#E0D9C4"><div id="spryradio2">
        		...
        		<span class="radioRequiredMsg">Please make a selection.</span></div>
        		<p>&nbsp;</p></td>
        	<td valign="top" bgcolor="#E3E3E3"><p>one reason to link JavaScript as an external script is when it is meant to serve more than one HTML</p></td>
        	</tr>
        <tr>
        	...
        	<td valign="top" bgcolor="#E0D9C4"><div id="spryradio3">
        		...
        		<span class="radioRequiredMsg">Please make a selection.</span></div>
        		<p>&nbsp;</p></td>
        	<td valign="top" bgcolor="#E3E3E3"><p>JavaScript is case sensitive.</p></td>
        	</tr>
        <tr>
        	...
        	<td valign="top" bgcolor="#E0D9C4"><div id="spryradio4">
        		...
        		<span class="radioRequiredMsg">Please make a selection.</span></div>
        		<p>&nbsp;</p></td>
        	<td valign="top" bgcolor="#E3E3E3"><p>every line in JavaScript should end with one of these three characters<br>
        			<span class="myemph">; { } </span></p></td>
        	</tr>
        <tr>
        	...
        	<td valign="top" bgcolor="#E0D9C4"><div id="spryradio5">
        		...
        		<span class="radioRequiredMsg">Please make a selection.</span></div>
        		<p>&nbsp;</p></td>
        	<td valign="top" bgcolor="#E3E3E3"><p>One reason to give selectors in HTML an id, is so JavaScript can find then, using <strong>getElemetById()</strong></p></td>
        	</tr>
        <tr>
        	...
        	<td valign="top" bgcolor="#E0D9C4"><div id="spryradio6">
        		...
        		<span class="radioRequiredMsg">Please make a selection.</span></div>
        		<p>&nbsp;</p></td>
        	<td valign="top" bgcolor="#E3E3E3"><p>it is better practice to link to a local copy of the Jquery library, not a CDN</p></td>
        	</tr>
        <tr>
        	...
        	<td valign="top" bgcolor="#E0D9C4"><div id="spryradio7">
        		...
        		<span class="radioRequiredMsg">Please make a selection.</span></div>
        		<p>&nbsp;</p></td>
        	<td valign="top" bgcolor="#E3E3E3"><p>We declare vars outside functions, so their scope is available to all the functions in the script.</p></td>
        	</tr>
        <tr>
        	...
        	<td valign="top" bgcolor="#E0D9C4"><div id="spryradio8">
        		...
        		<span class="radioRequiredMsg">Please make a selection.</span></div>
        		<p>&nbsp;</p></td>
        	<td valign="top" bgcolor="#E3E3E3"><p>the link to the Jquery library, local or CDN,must come AFTER the link to our own JavaScript.</p></td>
        	</tr>
        <tr>
        	...
        	<td valign="top" bgcolor="#E0D9C4"><div id="spryradio9">
        		...
        		<span class="radioRequiredMsg">Please make a selection.</span></div>
        		<p>&nbsp;</p></td>
        	<td valign="top" bgcolor="#E3E3E3"><p>all objects in Jquery start with #</p></td>
        	</tr>
        <tr>
        	...
        	<td valign="top" bgcolor="#E0D9C4"><div id="spryradio10">
        		...
        		<span class="radioRequiredMsg">Please make a selection.</span></div>
        		<p>&nbsp;</p></td>
        	<td valign="top" bgcolor="#E3E3E3"><p>the function <strong>parseInt()</strong> is used to concatenate strings</p></td>
        	</tr>
        <tr>
        ...
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="640" valign="top" bgcolor="#E3E3E3"><p>to declare a variable for the first time, we start with<strong class="myemph"> var</strong> and then the name we gave it</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="640" valign="top" bgcolor="#E3E3E3"><p>a variable and a function are the same thing.</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="640" valign="top" bgcolor="#E3E3E3"><p>The function isNaN() is used in order to find out if a number is positive or negative.</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="640" valign="top" bgcolor="#E3E3E3"><p>an<span class="myemph"> if()</span> statement must have a condition in the parenthesis</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="640" valign="top" bgcolor="#E3E3E3"><p>an<span class="myemph"> if()</span> statement must end with <span class="myemph">endIf()</span></p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="640" valign="top" bgcolor="#E3E3E3"><p>the Jquery function &quot;slide&quot; can only slide left or right, not up or down</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="640" valign="top" bgcolor="#E3E3E3"><p>the third parameter in a <span class="myemph">for()</span> loop is the increment</p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="640" valign="top" bgcolor="#E3E3E3"><p>every script that uses Jquery should be enclosed in<br>
          </p>
          	<p class="myemph">$(document).ready(function(){</p>
          	<p class="myemph">}); </p></td>
        </tr>
        <tr>
          ...
          <span class="radioRequiredMsg">Please make a selection.</span></div>            <p>&nbsp;</p></td>
          <td width="640" valign="top" bgcolor="#E3E3E3"><p>if we write</p>
          	<p class="myemph">var myVar=&quot;453&quot;;</p>
          	<p>then the value of this var is a string, not a number.</p></td>
        </tr>
        <tr>
